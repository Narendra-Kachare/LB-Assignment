...
/*
    ...
    all such elements which are divisible by 5 and which are even.
...
class ArrayDemo
{
    ...
    {
        System.out.println("Even elements of array which is divisible by 5 is : ");
        for(int iCnt = 0; iCnt < Arr.length; iCnt++)
        {
            if((Arr[iCnt] % 5 == 0) && (Arr[iCnt] % 10 == 0))
            {
